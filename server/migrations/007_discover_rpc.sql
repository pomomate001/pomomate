-- 007_discover_rpc.sql
-- Server-side discovery RPC function with multi-factor scoring
-- Replaces client-side 7-query approach with a single efficient RPC call
...
GRANT EXECUTE ON FUNCTION public.discover_users(INT, INT, TEXT, TEXT) TO authenticated;
