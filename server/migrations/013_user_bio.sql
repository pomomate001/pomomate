-- 013_user_bio.sql
-- Add bio (short about text) column to users table
-- and update discover_users RPC to include bio in results

-- 1. Add bio column to users table
ALTER TABLE users ADD COLUMN IF NOT EXISTS bio TEXT DEFAULT NULL;

-- 2. Recreate discover_users RPC to include bio field
...
BEGIN
  ...
  RETURN QUERY
  WITH candidates AS (
    SELECT u.id, u.display_name, u.avatar_url, u.country_code, u.bio
    FROM users u
